...
<form name="ftest" action="charHold_add.do" method="post" id="ftest" enctype="multipart/form-data">
<div class="container" id="menu_example" style="text-align: center;">
   ...
   <br>
   <div class="tab_cont center-block" style="background-color: #EFEFEF;">
      <section class="on">
            ...
            <div style="text-align: left;">
               ...
               <br>
               <div>
                  <textarea cols="40" rows="10" name="c_deas" id="deas"></textarea>
               </div>
               <hr>
               <div class="text-lg-end">
               <div style="text-align: center;">
               		<h5><b>2. 무엇을 디자인 해드릴까요?</b></h5>              
               </div>
               <br>
               <div style="float: none; margin : 0px auto">
                  <textarea cols="40" rows="10" name="c_idea" id="idea"></textarea>
               </div>
               <br>
               </div>            
               <hr>
               ...
               <br>
               <div>
                 <textarea cols="40" rows="10" name="c_details" id="details"></textarea>
               </div>
               <hr>
               <br>
               <div>
