...
public class ConDTO {
	...
	public ConDTO(int c_idx, int t_idx, String c_subject, String c_deas, String c_company, String c_cate, String c_logo,
			String c_color, String c_file, String c_name, String c_details, String c_idea, int c_readnum, int c_pay,
			Date c_opendate, Date c_enddate, int u_idx, String c_block, int c_datediff, MultipartFile upload) {
		super();
		this.c_idx = c_idx;
		this.t_idx = t_idx;
